...
import DashboardQuickActionDialog from "../Dialogs/DashboardQuickActionDialog/DashboardQuickActionDialog";
...
const TopBalance = ({
  ...
  return (
    <>
        ...
        <div className="bg-primary border-radius-14 w-100 balance-box rounder-sm-0 padding-30 margin-b-20">
          <div className="d-flex align-items-center justify-content-between margin-b-20">
            ...
            <div className="d-flex align-items-center btns">
              <button className="f-size-12 fw-medium btn btn-primary btn-primary-hover d-flex align-items-center justify-content-center" onClick={() => setOpenQuickActions(true)}>
      ...
      <DashboardQuickActionDialog open={openQuickActions} onClose={() => setOpenQuickActions(false)} />
    </>
