...
const BankTransferPaymentResult = ({ status = "success", onClose }) => {
  return (
    <div
                ...
                <div className="bg-white border-ea border-radius-14 padding-30 w-100 position-relative bank-transfer-success-payment-box">
                  <div className="text-center">
                    ...
                    <div className="bg-gray-500 rounded d-flex align-items-center justify-content-between padding-10 margin-b-10 bank-transfer-fee-block">
                      ...
                      <div className="fee-amount text-primary fw-semibold f-size-10">
                        R 150.00
                      </div>
                    </div>
                    <div className="form-group">
                      <button
                        className="btn btn-primary w-100 rounded f-size-12 fw-medium d-flex align-items-center justify-content-center margin-b-10"
                        onClick={onClose}
                      >
                        Done
                      </button>
                      <button
                        id="btnDownloadPOP"
                        className="btn btn-outline border border-ea w-100 rounded f-size-12 fw-medium d-flex align-items-center justify-content-center"
                      >
              ...
              <div className="w-100 mw-sm-340 bank-transfer-block">
                <div className="bg-white border-ea border-radius-14 padding-30 w-100 position-relative bank-transfer-payment-failed-box ">
                  <div className="text-center">
                    ...
                    <div className="f-size-12 text-gray-300 margin-b-20">
                      There was an error with your payment to Rozetka.
                    </div>
                    <div className="f-size-12 text-primary margin-b-20">
                      Error code: <span className="fw-bold"> S-H-500</span>
                    </div>
                    <div className="form-group margin-b-20">
                      <button onClick={onClose} className="btn btn-primary w-100 rounded f-size-12 fw-medium d-flex align-items-center justify-content-center margin-b-10">
                        Try again
                      </button>
                      <button
                        className="btn btn-outline border border-ea w-100 rounded f-size-12 fw-medium d-flex align-items-center justify-content-center"
                    ...
                    <div className="form-group text-center f-size-14 fw-medium text-gray-400">
                      ...
                      <a
                        href="mailto:support@thrive.trade"
                        title="support@thrive.trade"
